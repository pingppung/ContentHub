...
import com.example.contenthub.repository.LinkRepository;
...
public class NovelCrawlerServiceTest {
    ...
    @Mock
    private NovelRepository contentRepository;
    ...
    void setUp() {
        ...
        // .content(mockNovel)
        // .build();
        NovelLink newLink = new NovelLink(content.getLink().getUrl(), content.getLink().getSiteName(), content.getLink().getContentId(), mockNovel);
